...
//                var percorso = cache.coordConvert(config.cache_dir, tilemaps.cache, urlArray[2], urlArray[3], urlArray[4], numlevely, ext);
                var root = config.baseurl + config.cache_dir + '/' + tilemaps.cache + '/' + dirStruct.join('/') + '.' + ext;
                //fine controllo
                var format;
                if (ext == 'jpg')
                    format = 'jpeg';        
